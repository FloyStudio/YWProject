...
//  YWSwiftDemo
//
//  Created by wangyanqing on 2019/12/7.
...
class DemoMetalView: MTKView {
    ...
    override func draw() {
        ...
        currentRenderPassDescriptor.colorAttachments[0].clearColor = MTLClearColor(red: 1.0, green: 1.0, blue: 1.0, alpha: 1)
